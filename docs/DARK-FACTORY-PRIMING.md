...
| **Memory / [Engram](../starter-kit/instance/AUTHENTICATION.md#engram) checkpoints** | Write a running `docs/dark-factory/00-build-log.md` (or have the human keep a scratchpad) and re-read it when context gets long. |
